...
| Convention rules for a specific topic | Grep `reference/agent-conventions.md` for the section heading |
...
Grep `reference/agent-conventions.md` for the sections relevant to the file type:
...
Severity guide (Grep `reference/agent-conventions.md` for the relevant section to confirm):
...
After completing, check for `agents.local/extensions/agent-migrate-worker.md` — if it exists, read and follow its additional instructions.
