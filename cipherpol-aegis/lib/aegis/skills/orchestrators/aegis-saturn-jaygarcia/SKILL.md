...
`plan.md` follows the schema in `$CLAUDE_PLUGIN_ROOT/reference/aegis/saturn-jaygarcia-plan-format.md` — `## Open Questions` is the only section this skill branches on, and is omitted entirely when there's nothing to ask.
