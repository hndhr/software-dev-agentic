---
name: release
description: Cut a new version of the web-agentic starter kit — bumps VERSION, updates CHANGELOG, and creates a git tag.
context: fork
allowed-tools: Read, Write, Edit, Bash
---

You are cutting a new release of the web-agentic starter kit.
