...
Create a Response DTO following `.claude/reference/data-layer.md §4.1` and naming conventions in `.claude/reference/project.md §13`.

## Steps

1. **Read** `.claude/reference/data-layer.md §4.1`
