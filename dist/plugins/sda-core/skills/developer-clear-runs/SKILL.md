...
description: Remove all strategist run state from .claude/agentic-state/runs/. Clears stale state.json and stateholder-contract.md artifacts left by feature-strategist and other strategists.
user-invocable: true
allowed-tools: Bash
---
...
`.claude/agentic-state/runs/` holds per-feature strategist state written during a session:
