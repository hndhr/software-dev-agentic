...
- `url` (required): **always pass explicitly** — `https://grafana.mekari.io/api/datasources/proxy/uid/bb793898-48b7-4961-92f5-81d29bf1d114`
...
4. For each chunk, call `mcp__loki-mcp__loki_query` with:
   ...
   - `url`: `https://grafana.mekari.io/api/datasources/proxy/uid/bb793898-48b7-4961-92f5-81d29bf1d114`
