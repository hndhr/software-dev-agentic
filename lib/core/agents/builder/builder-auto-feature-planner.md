...
description: DEPRECATED — responsibilities absorbed into builder-feature-orchestrator (gather-intent-prefilled mode + synthesize mode) and builder-build-from-ticket skill (convergence loop). Do not invoke.
model: sonnet
