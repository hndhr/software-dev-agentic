...
> Concepts and invariants: `reference/code-architecture/data-theory.md`. This file covers Dart syntax and Flutter-specific patterns.
...
## Local Data Source (Cache-First Pattern) <!-- 33 -->
