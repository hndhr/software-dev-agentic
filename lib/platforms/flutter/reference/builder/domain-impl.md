...
> Concepts and invariants: `reference/builder/domain-theory.md`. This file covers Dart syntax and Flutter-specific patterns.
...
Pure synchronous functions — no I/O, no async, no side effects. See extraction rules in `reference/builder/domain-theory.md`.
