...
Create a Domain Entity following `.claude/reference/domain.md §1`.

## Steps

1. **Grep** `.claude/reference/domain.md` for `## 1. Entities`; only **Read** the full file if the section cannot be located
