...
Create data layer tests following `.claude/reference/builder/testing-impl.md ## Repository Tests, ## Mapper Tests sections`.

## Steps

1. **Grep** `.claude/reference/builder/testing-impl.md` for `## Repository Tests` and `## Mapper Tests`
