...
Create a Repository interface following `.claude/reference/domain.md §2`.

## Steps

1. **Grep** `.claude/reference/domain.md` for `## 2. Repository`; only **Read** the full file if the section cannot be located
