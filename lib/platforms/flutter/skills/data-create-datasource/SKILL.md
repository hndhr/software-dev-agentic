...
Create a DataSource following `.claude/reference/data.md §4`.

## Steps

1. **Grep** `.claude/reference/data.md` for `## 4. Data Sources`; only **Read** the full file if the section cannot be located
