...
Create a Model and Mapper following `.claude/reference/data.md §1` and `§3`.

## Steps

1. **Grep** `.claude/reference/data.md` for `## 1. Models` and `## 3. Mappers`; only **Read** the full file if sections cannot be located
