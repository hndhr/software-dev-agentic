...
Create a UseCase following `.claude/reference/domain.md §3`.

## Steps

1. **Grep** `.claude/reference/domain.md` for `## 3. Use Cases`; only **Read** the full file if the section cannot be located
