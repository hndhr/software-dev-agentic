...
Create a BLoC following `.claude/reference/presentation.md §2–4` and DI rules in `.claude/reference/di.md §3`.

## Steps

1. **Grep** `.claude/reference/presentation.md` for `## 2. Events` and `## 3. States`; only **Read** the full file if sections cannot be located
