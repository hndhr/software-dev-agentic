...
Create a ViewModel test suite following `.claude/reference/contract/testing.md ## ViewModel Tests, ## Mapper Tests sections` and patterns in `.claude/reference/testing-patterns-advanced.md`.
