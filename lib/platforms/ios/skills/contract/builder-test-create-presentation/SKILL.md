...
Create a ViewModel test suite following `.claude/reference/builder/testing-impl.md ## Presenter Tests, ## Mapper Tests sections` and patterns in `.claude/reference/testing-patterns-advanced.md`.
