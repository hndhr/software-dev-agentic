...
> Concepts and invariants: `reference/builder/domain-theory.md`. This file covers TypeScript syntax and web-specific patterns.
...
Pure business decisions — no I/O, no side effects, no async. See extraction rules in `reference/builder/domain-theory.md`.
