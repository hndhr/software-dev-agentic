...
Create a reusable UI component following `reference/builder/presentation-impl.md`.
...
**Pattern:** `reference/builder/presentation-impl.md` — `Grep` for component/organism section.
