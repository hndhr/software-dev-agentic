...
Platform syntax and patterns: `reference/builder/app-layer-impl.md` in each platform directory.
...
Platform-specific implementation patterns: platform `reference/builder/hybrid-embedding-impl.md`.
