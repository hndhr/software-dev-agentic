...
> Concepts and invariants: `reference/builder/app-layer-theory.md`. This file covers Kotlin/Dagger 2 patterns for Android.
...
> Canonical terms and invariants: `reference/builder/app-layer-theory.md` — `## Hybrid Embedding` section.
